        ...
        <tbody>
            {books.map((book, index) => (
                <tr key = {book._id} className='h-8'>
                    ...
                    <td className='border border-slate-700 rounded-md text-center msx-md:hidden'>{book.author}</td>
                    <td className='border border-slate-700 rounded-md text-center msx-md:hidden'>{book.publishYear}</td>
